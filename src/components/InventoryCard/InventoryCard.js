    ...
    return (
      <div key={inventory.id} className="inventory-card">
        <div className="inventory-card__container inventory-card__container--items">
          <h3 className="inventory-card__title inventory-card__title--hidden">
            INVENTORY ITEM
          </h3>
          <Link
          ...
          <p
            className={
              inventory.status === "In Stock"
                ? "inventory-card__status inventory-card__status--is"
                : "inventory-card__status inventory-card__status--oos"
            }
          >
            {inventory.status}
          </p>
        ...
        <div className="inventory-card__container inventory-card__container--margin inventory-card__container--warehouse">
          ...
          <p className="inventory-card__paragraph">
            {inventory.warehouse_name}
          </p>
        </div>
        <div className="inventory-card__container inventory-card__container--buttons">
          <button
            onClick={() => handleDelete(inventory.id, inventory.item_name)}
            className="inventory-card__button btn-openModal"
          >
