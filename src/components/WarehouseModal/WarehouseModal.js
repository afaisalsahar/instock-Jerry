    ...
    return(
        <div open={isOpen}>
            <article className="warehouse-modal__container">
                ...
                <p className="warehouse-modal__details">Please confirm that you’d like to delete the {warehouseName} from the list of warehouses. You won’t be able to undo this action.</p>
